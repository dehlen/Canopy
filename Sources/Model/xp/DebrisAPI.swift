...
public struct SignIn: Codable {
    ...
    public init(deviceToken: String, apnsTopic: String, production: Bool) {
        self.deviceToken = deviceToken
        self.apnsTopic = apnsTopic
        self.production = production
    }
...
public enum RemoteNotificationUserInfo {
...
public enum API {
    public struct Enroll: Codable {
        ...
        public init(createHooks: [Node], enrollRepoIds: [Int]) {
            self.createHooks = createHooks
            self.enrollRepoIds = enrollRepoIds
        }
    }
    public struct Unenroll: Codable {
        public let repoIds: [Int]

        public init(repoIds: [Int]) {
